	...
	test('createSvgWrapperComponent should create Vue file', async function() {
		...
		try {
			...
			const modulesToClear = [
				...
				'../commands/svgToVue/helpers/createSvgWrapperComponent/helpers/getVueFileContent',
				'../commands/svgToVue/helpers/createSvgWrapperComponent/helpers/helpers/getSvgFromClipboard/getSvgFromClipboard'
			];
