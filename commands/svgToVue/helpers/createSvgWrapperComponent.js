 ...
 * @param {String} targetDirectory - The parent directory of the to be created file. 
 * Will be created if it doesn't exist.
 * @param {String} filename - The name of the file with a .vue ending, eg 'MySvg.vue'
 * @param {String} filePath - The complete path to the file, eg /user/.../MySvg.vue
 */
async function createSvgWrapperComponent(targetDirectory, filename, filePath) {
  try {
